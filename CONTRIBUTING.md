# How to Contribute
1. The `namespace-operator` team welcomes contributions from the community.  Before you start working with `namespace-operator`, please read our [Developer Certificate of Origin](https://cla.vmware.com/dco).  All contributions to this repository must be signed as described on that page.  Your signature certifies that you wrote the patch or have the right to pass it on as on open-source patch.
